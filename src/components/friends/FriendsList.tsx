  ...
  return (
    <div>
      ...
      <ul className="flex flex-col gap-1">
        {friendProfilesLoading && <li className="text-xs text-gray-500">Loading friends...</li>}
        {!friendProfilesLoading && friendProfiles.length === 0 && <li className="text-xs text-gray-500">You have no friends yet.</li>}
